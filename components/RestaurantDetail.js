  ...
  return (
    <div className="flex flex-col">
      ...
      <div className='pl-3 pt-2 h-1/5 bg-dark-jungle-green flex flex-col w-full'>
        <div className='font-bold text-3xl tracking-wide mt-2 mb-2 text-white'>{restaurant.restaurantName}</div>
        ...
        <div className="h-8 mt-4 mb-2 flex justify-start w-2/3">
          <div className="text-white bg-military-green w-20 h-6 rounded-2xl text-sm flex justify-center items-center mr-4">$$$</div>
          <div className="text-white bg-flat-blue w-20 h-6 rounded-2xl text-sm flex justify-center items-center mr-4">Fast</div>
          <div className="text-white bg-reef-gold w-20 h-6 rounded-2xl text-sm flex justify-center items-center">12 miles</div>
        </div>
      ...
      <div className="h-1 w-full  bg-[#38474F]">
      </div>
